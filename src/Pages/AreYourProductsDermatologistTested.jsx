...
const AreYourProductsDermatologistTested = () => {
  return (
<>
    <FaqTemplates
    question="Are your products dermatologist-tested?"
    main="Yes, all our products are tested under the supervision of dermatologists to ensure they are safe, effective, and suitable for different skin types."
...
export default AreYourProductsDermatologistTested