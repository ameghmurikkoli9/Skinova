...
const CanITrackMyOrder = () => {
  return (
    <>
    <FaqTemplates
    question="Can I track my order?"
    main="Absolutely! Once your order has been shipped, you will receive a tracking number via email. Use it to monitor your package’s progress and estimated delivery date."
...
export default CanITrackMyOrder