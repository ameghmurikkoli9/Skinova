...
// Product data for cleansers only
...
const Cleanser = () => {
  ...
  // Filter products
  let filteredProducts = cleanserProducts.filter((product) => {
    ...
    <div className="category-page">
      ...
      <div className="category-hero">
        <div className="category-hero-content">
          <h1 className="category-hero-title">Cleansers</h1>
          <p className="category-hero-description">
            Gently remove dirt and impurities without stripping your skin. Perfect for a
            fresh, clean start every day.
          </p>
          <button className="explore-btn" onClick={handleExploreCollection}>Explore Collection ↓</button>
        </div>
        <div className="category-hero-image">
          <img src={CleanserImg1} alt="Cleansers" />
        </div>
      </div>
      ...
      <div className="category-header">
        <div className="breadcrumb">
          ...
          <span> &gt; </span>
          <span className="breadcrumb-active">Cleansers</span>
        </div>
