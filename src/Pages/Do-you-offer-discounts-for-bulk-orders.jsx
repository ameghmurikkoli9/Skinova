...
const DoYouOfferDiscountsForBulkOrders = () => {
  return (
    <>
    <FaqTemplates
    question="Do you offer discounts for bulk orders?"
    main="Yes, we offer discounts on large orders for personal or business use. Contact us to learn more about our bulk pricing options."
...
export default DoYouOfferDiscountsForBulkOrders ;