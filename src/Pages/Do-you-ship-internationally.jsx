...
const DoYouShipInternationally   = () => {
  return (
    <>
    <FaqTemplates
    question="Do you ship internationally?"
    main="Yes, we ship to many countries worldwide. Shipping costs and delivery times vary depending on your location. Additional customs fees may apply based on your country’s regulations."
...
export default DoYouShipInternationally  