...
const DoYourProductsContainSyntheticFragrances = () => {
  return (
<>
    <FaqTemplates
    question="Do your products contain synthetic fragrances?"
    main="No, we avoid synthetic fragrances to minimize irritation and focus on using naturally derived scents from essential oils or botanical extracts."
...
export default DoYourProductsContainSyntheticFragrances