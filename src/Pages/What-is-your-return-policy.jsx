...
const WhatIsYourReturnPolicy = () => {
  return (
<>
    <FaqTemplates
    question="What is your return policy?"
    main="We accept returns within 30 days of purchase for unused and unopened products. To initiate a return, contact our customer support team with your order details. Refunds will be processed once we receive the returned items."
...
export default WhatIsYourReturnPolicy